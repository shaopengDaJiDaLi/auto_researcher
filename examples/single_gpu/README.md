...
This guide shows how to set up Auto Researcher for a single-GPU research project.
...
```bash
python -m auto_researcher.runner --project . --gpu 0
```

## 5. Monitor

Check `workspace/MEMORY_LOG.md` for the agent's progress.
Check `auto_researcher.log` for detailed logs.
